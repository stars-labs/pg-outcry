...
[← Back to project README](../README.md) · [← 返回项目 README](../README.zh-CN.md)

Every doc is bilingual: an English file and a `*.zh-CN.md` mirror with a language switcher at the top.
每篇文档都是双语的：英文文件 + `*.zh-CN.md` 中文镜像，顶部带语言切换。
...
> `LAUNCH.md` is an internal promotion playbook, not product documentation. / `LAUNCH.md` 是内部发布预案，非产品文档。
